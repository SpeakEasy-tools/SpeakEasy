...
function DataGraph({ data, xLabel, seriesNames }) {
            ...
            <div className={clsx(classes.row)}>
                <div className={clsx(classes.pad)}>
                    <Typography paragraph>
                        Click and drag on an area of the graph to zoom in. Press
                        the reset button to reset the graph.
                    </Typography>
                </div>
                <Button
                ...
                {data && xLabel && seriesNames.length && (
                    <ResponsiveContainer>
                        <LineChart
                            ...
                            onMouseMove={e =>
                                downLocation && setUpLocation(e.activeLabel)
                            }
