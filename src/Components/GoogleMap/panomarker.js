...
(function(global, factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define([
            "goog!maps,3,other_params:[sensor=false&libraries=visualization]"
        ], factory);
    } else {
    ...
    PanoMarker.prototype.onAdd = function() {
        ...
        this.povListener_ = google.maps.event.addListener(
            this.getMap(),
            "pov_changed",
            this.draw.bind(this)
        );
    ...
    PanoMarker.prototype.draw = function() {
        ...
        var offset = this.povToPixel_(
            this.position_,
            this.pano_.getPov(),
            typeof this.pano_.getZoom() !== "undefined"
                ? this.pano_.getZoom()
                : 1,
            this.container_
        );
    ...
    PanoMarker.prototype.setIcon = function(icon) {
        this.icon_ = icon;
        if (this.marker_) {
            this.marker_.style.backgroundImage = icon
                ? "url(" + icon + ")"
                : "";
        }
    };
