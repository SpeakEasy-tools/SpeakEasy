...
function FAQ() {
    ...
    const content = [
        ...
        "To create a profile, click the profile icon to open up the sign in menu and select your preferred sign in method. Currently supported sign in methonds are email, Google, Twitter, and GitHub.",
