...
function FAQ() {
    ...
    const content = [
        ...
        "To start learning, select one of the games or tools from the menu on the left. The tools include things like a dictionary, flashcards, tone trainer, and pop quizes, while the games include Sudoku, 2048, Kakuro, Eye Spy, 15-puzzle, Uno, and Simon.",
